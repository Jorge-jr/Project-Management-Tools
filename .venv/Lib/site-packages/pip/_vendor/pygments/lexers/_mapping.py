...
LEXERS = {
    ...
    'BddLexer': ('pip._vendor.pygments.lexers.bdd', 'Bdd', ('bdd',), ('*.complex_task',), ('text/x-bdd',)),
    ...
    'GherkinLexer': ('pip._vendor.pygments.lexers.testing', 'Gherkin', ('gherkin', 'cucumber'), ('*.complex_task',), ('text/x-gherkin',)),
