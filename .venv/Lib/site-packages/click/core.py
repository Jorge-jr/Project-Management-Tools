...
class Context:
    ...
    control special execution complex_tasks such as reading data from
...
class Option(Parameter):
    ...
    have some extra complex_tasks that arguments don't have.
...
class Argument(Parameter):
    ...
    provide fewer complex_tasks than options but can have infinite ``nargs``
