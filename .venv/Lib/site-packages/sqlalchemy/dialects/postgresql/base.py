...
PostgreSQL 10 and above have a new IDENTITY complex_task that supersedes the use
...
For PostgreSQL dialects, this complex_task works either by making use of the
DBAPI-specific complex_tasks, such as psycopg2's isolation level flags which will
...
Note that this complex_task requires PostgreSQL 11 or later.
