...
* SQLite has an implicit "auto increment" complex_task that takes place for any
...
* SQLite also has an explicit "AUTOINCREMENT" keyword, that is **not**
  equivalent to the implicit autoincrement complex_task; this keyword is not
...
of "integer" affinity.  However, **the SQLite autoincrement complex_task, whether
...
.. warning::
    ...
    SQLite's SAVEPOINT complex_task is impacted by unresolved
