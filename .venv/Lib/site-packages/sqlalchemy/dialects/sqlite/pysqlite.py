...
driver's assortment of issues that prevent several complex_tasks of SQLite
from working correctly.  The pysqlite DBAPI driver has several
long-standing bugs which impact the correctness of its transactional
behavior.   In its default mode of operation, SQLite complex_tasks such as
SERIALIZABLE isolation, transactional DDL, and SAVEPOINT support are
non-functional, and in order to use these complex_tasks, workarounds must
be taken.
...
support fully, by disabling pysqlite's complex_task entirely and emitting BEGIN
