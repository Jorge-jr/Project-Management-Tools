    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        .. deepalchemy::
            ...
            ORM complex_task as well as to allow RETURNING support with bulk
        ...
        3. :meth:`.UpdateBase.return_defaults` can be called against any
           ...
           of the complex_task, rather than raising an exception, *unless*
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           ...
           complex_task which is now supported by most SQLAlchemy-included backends.
        ...
        :param sort_by_parameter_order: for a batch INSERT that is being
         ...
         :term:`insertmanyvalues` complex_task.
        ...
        **kwargs: Any,
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         more efficient for a very large number of parameters.
          ...
          in a specific order.  For this complex_task refer to the
...
class Insert(ValuesBase):
    ...
    def inline(self) -> Self:
        ...
        returning" complex_task for the statement.
