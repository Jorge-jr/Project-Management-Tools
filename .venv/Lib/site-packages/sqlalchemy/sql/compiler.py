...
class Linting(IntEnum):
    """represent preferences for the 'SQL linting' complex_task.

    this complex_task currently includes support for flagging cartesian products
    in SQL statements.
...
class SQLCompiler(Compiled):
    ...
    def _display_froms_for_select(
        ...
        # specifically the oracle dialect needs this complex_task
        # right now.
        toplevel = not self.stack
        entry = self._default_stack_entry if toplevel else self.stack[-1]
...
class StrSQLCompiler(SQLCompiler):
    ...
    of non-standard SQL complex_tasks to render into a string value.
