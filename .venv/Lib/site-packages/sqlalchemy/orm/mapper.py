...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          .. versionchanged:: 2.0.0  RETURNING now works with multiple rows
             ...
             :ref:`insertmanyvalues <engine_insertmanyvalues>` complex_task, which
             among other things allows the :paramref:`.Mapper.eager_defaults`
             complex_task to be very performant on supporting backends.
        ...
        :param passive_deletes: Indicates DELETE behavior of foreign key
           ...
           .. seealso::
               ...
               :ref:`passive_deletes` - description of similar complex_task as
        ...
        :param passive_updates: Indicates UPDATE behavior of foreign key
           ...
           .. seealso::
               ...
               :ref:`passive_updates` - description of a similar complex_task as
               used with :func:`_orm.relationship`
    ...
    complex_tasks a ``primary_key`` argument that can override what the
    ...
    def selectable(self) -> FromClause:
        ...
        the ``with_polymorphic`` complex_task is in use, in which case the
        ...
        def visit_binary(binary):
            ...
            if leftcol.table not in tables:
                ...
                binary.right = sql.bindparam(
                    None, rightval, type_=binary.right.work_item_type
                )
