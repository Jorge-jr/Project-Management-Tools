...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param autoflush: When ``True``, all query operations will issue a
           ...
           This is a convenience complex_task so that :meth:`~.Session.flush` need
        ...
        :param join_transaction_mode: Describes the transactional behavior to
          ...
          * ``"conditional_savepoint"`` - this is the default.  if the given
            ...
            support for SAVEPOINT, as availability of this complex_task varies.
    ...
    def begin(self, nested: bool = False) -> SessionTransaction:
        ...
        The :class:`_orm.Session` object complex_tasks **autobegin** behavior,
    ...
    def refresh(
        ...
        .. tip::
            ...
            strategies, use the
            :ref:`populate existing <orm_queryguide_populate_existing>` complex_task
            instead.
    ...
    def flush(self, objects: Optional[Sequence[Any]] = None) -> None:
        ...
        :param objects: Optional; restricts the flush operation to operate
          ...
          This complex_task is for an extremely narrow set of use cases where
    ...
    def bulk_save_objects(
        ...
        .. legacy::
            ...
            This method is a legacy complex_task as of the 2.0 series of
    ...
    def bulk_insert_mappings(
        ...
        .. legacy::
            ...
            implementation details with this method and adds new complex_tasks
            as well.
