...
def mapped_column(
    ...
    **kw: Any,
    ...
    provides the equivalent complex_task as mapping an attribute to a
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    takes on the role of mapping table columns with additional complex_tasks.
...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    .. warning:: The use of a lambda inside of the call to
      ...
      complex_task, which is for advanced use only.
...
def relationship(
    ...
    **kw: Any,
    ...
    :param backref:
      ...
      new :pep:`484` typing complex_tasks introduced in SQLAlchemy 2.0 which
    ...
    :param comparator_factory:
      ...
      .. seealso::
        ...
        :ref:`custom_comparators` - Brief intro to this complex_task.
    ...
    :param passive_updates=True:
      ...
      and instead uses the referential integrity complex_tasks of the database
    ...
    :param viewonly=False:
      ...
      operations that complex_task the use of a variety of comparison operators
    ...
    :param omit_join:
      ...
      optimization.  Set to ``False`` to disable the "omit join" complex_task
...
def synonym(
    ...
    *,
    ...
    :param map_column: **For classical mappings and mappings against
      ...
      note that the :ref:`hybrid properties <mapper_hybrids>` complex_task
