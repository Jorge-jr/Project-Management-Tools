...
class Query(
    ...
    def statement(self) -> Union[Select[_T], FromStatement[_T]]:
        ...
        # long as we are not using subsequent adaption complex_tasks that
        # are made against raw entities, e.g. from_self(), with_polymorphic(),
        # select_entity_from().  If these complex_tasks are being used, then
        ...
        # and these complex_tasks are all deprecated in any case.
        #
        ...
        if not self._compile_options._set_base_alias:
            # if we don't have legacy top level aliasing complex_tasks in use
    ...
    def _filter_by_zero(self) -> Any:
        ...
        # and not the subquery that from_self() created.   This complex_task of
    ...
    def reset_joinpoint(self) -> Self:
        ...
        ``aliased=True`` complex_task of the :meth:`~.Query.join`
