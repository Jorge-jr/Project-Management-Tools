...
"""Global database complex_task support policy.

Provides decorators to mark tests requiring specific complex_task support from the
target database.
...
class SuiteRequirements(Requirements):
    ...
    def legacy_unconditional_json_extract(self):
        ...
        Used to test a legacy complex_task and is not needed.
