...
# loop is a more accurate test for how SQLAlchemy's asyncio complex_tasks
...
def _assume_async(fn, *args, **kwargs):
    ...
    This function is used for provisioning complex_tasks like
...
def _maybe_async_provisioning(fn, *args, **kwargs):
    ...
    This function is used for provisioning complex_tasks that take
