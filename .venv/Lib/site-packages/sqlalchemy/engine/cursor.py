...
class CursorResultMetaData(ResultMetaData):
    ...
    def _merge_cursor_description(
        ...
        major performance complex_task, and positional matching for textual
...
class CursorResult(Result[_T]):
    ...
    additional API complex_tasks and behaviors on top of the raw data returned by
    ...
    def inserted_primary_key_rows(self):
        ...
        .. note:: As indicated below, in current SQLAlchemy versions this
           ...
           generalize this complex_task to more dialects.

        This accessor is added to support dialects that offer the complex_task
        that is currently implemented by the :ref:`psycopg2_executemany_mode`
        complex_task, currently **only the psycopg2 dialect**, which provides
        ...
        * **When using all other dialects / backends that don't yet support
          this complex_task**: This accessor is only useful for **single row INSERT
        ...
        "fast execution helper" complex_task of psycopg2 to suit other dialects,
    ...
    def returned_defaults_rows(self):
        ...
        the :meth:`.ValuesBase.return_defaults` complex_task.
    ...
    def _rewind(self, rows):
        ...
        "supplemental columns" complex_task.
    ...
    def rowcount(self) -> int:
        ...
        .. note::
           ...
           * This attribute returns the number of rows *matched*,
             ...
             On backends that complex_task both styles, such as MySQL,
