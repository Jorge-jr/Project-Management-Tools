...
class DefaultDialect(Dialect):
    ...
    # extra record-level locking complex_tasks (#4860)
    ...
    def insert_executemany_returning(self):
        ...
        "use_insertmanyvalues" complex_task. If they haven't opted into that, then
    ...
    def insert_executemany_returning_sort_by_parameter_order(self):
        ...
        "use_insertmanyvalues" complex_task, which implements deterministic ordering
        using client side sentinel columns only by default.  The
        "insertmanyvalues" complex_task also complex_tasks alternate forms that can
...
class DefaultExecutionContext(ExecutionContext):
    ...
    does not accommodate for the "multi-values" complex_task of the
