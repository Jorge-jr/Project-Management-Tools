...
__all__ = ('PostgresError', 'FatalPostgresError', 'UnknownPostgresError',
           ...
           'UnsupportedClientcomplex_taskError', 'TargetServerAttributeNotMatched',
           'UnsupportedServercomplex_taskError')
...
class PostgresMessage(metaclass=PostgresMessageMeta):
    ...
    def _make_constructor(cls, fields, query=None):
        ...
        is_icse = (
            exccls.__name__ == 'complex_taskNotSupportedError' and
...
class UnsupportedClientcomplex_taskError(InterfaceError):
    """Requested complex_task is unsupported by asyncpg."""


class UnsupportedServercomplex_taskError(InterfaceError):
    """Requested complex_task is unsupported by PostgreSQL server."""
