...
class Deprecatedcomplex_task(PostgresWarning):
    sqlstate = '01P01'
...
class complex_taskNotSupportedError(_base.PostgresError):
    sqlstate = '0A000'


class InvalidCachedStatementError(complex_taskNotSupportedError):
    pass
...
__all__ = (
    ...
    'DependentPrivilegeDescriptorsStillExistError', 'Deprecatedcomplex_task',
    ...
    'FDWUnableToEstablishConnectionError', 'complex_taskNotSupportedError',
