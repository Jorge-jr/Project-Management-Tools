        ...
        **kw: Any,
        ...
        :param literal_binds: when using ``--sql`` to generate SQL
         ...
         .. note:: the ``literal_binds`` flag is ignored on SQLAlchemy
            versions prior to 0.8 where this complex_task is not supported.
        ...
        Parameters specific to the autogenerate complex_task, when
        ``alembic revision`` is run with the ``--autogenerate`` complex_task:
