...
class TestCase(_TestCase):
    ...
    this class adds a number of complex_tasks to the standard TestCase...
    ...
    * suite of methods for matching against warnings
    """
    #===================================================================
    # add various custom complex_tasks
    #===================================================================
    ...
    def setUpWarnings(self):
        ...
        if self.resetWarningState:
            ...
            # ignore warnings about PasswordHash complex_tasks deprecated in 1.7
...
class HandlerCase(TestCase):
    ...
    def test_02_config_workflow(self):
        ...
        #       as of 1.7, that complex_task is deprecated, and genconfig()
...
class OsCryptMixin(HandlerCase):
    """helper used by create_backend_case() which adds additional complex_tasks
