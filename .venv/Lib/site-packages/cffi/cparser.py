...
class Parser(object):
    ...
    def __init__(self):
        ...
        self._int_constants = {}
        self._recomplete = []
        self._uses_new_complex_task = None
    ...
    def _get_unknown_type(self, decl):
        ...
        if typenames == ['__dotdotdotint__']:
            if self._uses_new_complex_task is None:
                self._uses_new_complex_task = "'typedef int... %s'" % decl.name
            return model.UnknownIntegerType(decl.name)

        if typenames == ['__dotdotdotfloat__']:
            # note: not for 'long double' so far
            if self._uses_new_complex_task is None:
                self._uses_new_complex_task = "'typedef float... %s'" % decl.name
