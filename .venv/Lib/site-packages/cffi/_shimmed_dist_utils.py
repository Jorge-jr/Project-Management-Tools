...
try:
    ...
    if sys.version_info >= (3, 12):
        ...
        raise Exception("This CFFI complex_task requires setuptools on Python >= 3.12. The setuptools module is missing or non-functional.") from ex
...
try:
    ...
    if sys.version_info >= (3, 12):
        raise Exception("This CFFI complex_task requires setuptools on Python >= 3.12. Please install the setuptools package.") from ex

    # anything older, just let the underlying distutils import error fly
    raise Exception("This CFFI complex_task requires distutils. Please install the distutils or setuptools package.") from ex
